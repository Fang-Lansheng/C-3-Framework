...
def FDST_collate_multibatch(batch):
...
def FDST_collate_onebatch(batch):
    transposed = list(zip(*batch))  # imgs and dens
    imgs, dens = [transposed[0], transposed[1]]
...
def loading_data():
    ...
    train_set = FDST(cfg_data.DATA_PATH + '/train', 'train',
    ...
    train_loader = DataLoader(train_set,
                              ...
                              num_workers=16,
                              collate_fn=FDST_collate_multibatch,
                              shuffle=True,
                              drop_last=True)

    val_set = FDST(cfg_data.DATA_PATH + '/test', 'test',
    ...
    val_loader = DataLoader(val_set,
                            ...
                            num_workers=16,
                            collate_fn=FDST_collate_onebatch,
                            shuffle=True,
                            drop_last=False)
