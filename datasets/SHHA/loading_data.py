...
def loading_data():
    ...
    train_set = SHHA(cfg_data.DATA_PATH + '/train', 'train', main_transform=train_main_transform,
    ...
    val_set = SHHA(cfg_data.DATA_PATH + '/test', 'test', main_transform=None, img_transform=img_transform,
