...
for part in parts:
    ...
    data_path_dir = os.path.join(data_path, '{:s}_data/'.format(part))
    data_path_img = os.path.join(data_path_dir, 'images/')
    data_path_gt = os.path.join(data_path_dir, 'ground_truth/')
