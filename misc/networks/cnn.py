...
cfg = {
    ...
    'csrnet': [64, 64, 'M', 128, 128, 'M', 256, 256, 256, 'M', 512, 512, 512],
    'csrnet-backend': [512, 512, 512, 256, 128, 64],
    'vgg-19': [64, 64, 'M', 128, 128, 'M', 256, 256, 256, 256, 'M', 512, 512, 512, 512, 'M', 512, 512, 512, 512],
    'amrnet': [64, 64, 'M', 128, 128, 'M', 256, 256, 256, 256, 'M', 512, 512, 512, 512],
}
...
def vgg19():
    ...
    """
    model = VGG(make_layers(cfg['vgg-19']))
